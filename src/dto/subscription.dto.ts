...
export class CreateSubscriptionDto {
  ...
  @ApiPropertyOptional({
    example: 'alternate',
    description: 'Skip pattern for NTH_DAY plan (e.g. "alternate")',
  })
  @IsString()
  @IsOptional()
  skipPattern?: string;
  ...
  @ApiPropertyOptional({
    example: 1,
    description: 'Quantity per delivery (default: 1)',
    default: 1,
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    example: 3,
    description: 'For NTH_DAY plan type - deliver every nth day',
  })
  @IsNumber()
  @IsOptional()
  @Min(1)
