...
export class Subscription {
  ...
  @Column({
    type: 'json',
    nullable: true,
    comment: 'Selected days for WEEKLY plan, e.g. ["Mon","Wed","Fri"]',
  })
  ...
  @Column({
    type: 'varchar',
    nullable: true,
    comment: 'Skip pattern for alternate days, e.g. "alternate"',
  })
  ...
  @Column({
    type: 'int',
    nullable: true,
    comment: 'Total number of deliveries calculated',
  })
  ...
  @Column({
    type: 'int',
    nullable: true,
    comment: 'Remaining deliveries (calculated on read)',
  })
  ...
  @Column({
    ...
    nullable: true,
    comment:
      'Total amount calculated: product.price × totalDeliveries × quantity',
  })
