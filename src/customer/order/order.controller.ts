...
export class OrderController {
  ...
  async updateCart(@CurrentUser() user: any, @Body() dto: UpdateCartDto) {
  ...
  @ApiResponse({
    status: 201,
    description: 'Order created and wallet debited',
    type: OrderResDto,
  })
  @ApiResponse({
    status: 400,
    description: 'Cart empty or insufficient balance',
  })
