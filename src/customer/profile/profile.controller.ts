import { Controller, Post, Get, Put, Body, Req, UseGuards, Query ,Delete} from '@nestjs/common';
...
export class CustomerProfileController {
    ...
    @ApiResponse({ status: 200, description: 'Admin phone number retrieved successfully' })
