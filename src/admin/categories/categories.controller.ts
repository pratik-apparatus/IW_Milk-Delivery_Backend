import { Controller, Post, Get, Put, Delete, Body, Param, Query, UseInterceptors, UploadedFile } from '@nestjs/common';
    ...
    @UseInterceptors(FileInterceptor('image', {
        ...
        fileFilter: (req, file, callback) => {
            ...
            if (!allowedExtensions.includes(fileExt)) {
                return callback(new Error('Images with jpg, webp, png are only allowed'), false);
            }
            // Validate MIME type
